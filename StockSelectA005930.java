...
public class StockSelectA005930 {
	public static void main(String[] args) throws ClassNotFoundException, SQLException { //ClassNotFoundException, SQLException이 발생하면 예외가 발생한 메소드를 호출 한 곳으로 예외 객체를 넘긴다.(throws)
		 ...
		 * ResultSet 객체로 전달한다.
		 */
		ResultSet k19_rset = k19_stmt.executeQuery("select * from stocks where shrn_iscd = 'A005930';"); // 삼성전자만 조회하는 쿼리 문장을 처리하고 ResultSet 객채로 반환.

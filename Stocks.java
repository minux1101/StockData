...
public class Stocks {
	  ...
	  private String stnd_iscd; /* NOT_NULL 표준 종목코드 */
      private int bsop_date; /* NOT_NULL 주식 영업 일자 */
      private String shrn_iscd; /* NOT_NULL 유가증권 단축 종목코드 */
      private int stck_prpr; /* 주식 종가 */
      private int stck_oprc; /* 주식 시가 */
      private int stck_hgpr; /* 주식 최고가 */
      private int stck_lwpr; /* 주식 최저가 */
      ...
      String ovtm_untp_prdy_vrss_sign; /* 시간외 단일가 전일 대비 부호 */
      ...
      String mrkt_div_cls_code; /* 시장 분류 구분 코드 */
      ...
      String frgn_limt_exhs_cls_code; /* 외국인 한도 소진 구분 코드 */
      ...
      String icic_cls_code; /* 증자 구분 코드 */
      long itmt_vol; /* 장중 거래량 */
      long itmt_tr_pbmn; /* 장중 거래대금 */
      String fcam_mod_cls_code; /* 액면가 변경 구분 코드 */
      String revl_issu_reas_code; /* 재평가 종목 사유 코드 */
      ...
      String fn_flng_cls_code; /* 락구분 코드 */
